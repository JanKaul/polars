...
declare global {
  namespace jest {
    interface Matchers<R> {
      toSeriesStrictEqual(expected): any;
      toSeriesEqual(expected): any;
      toFrameEqual(expected): any;
      toFrameStrictEqual(expected): any;
      toFrameEqualIgnoringOrder(expected): any;
    }
  }
}
